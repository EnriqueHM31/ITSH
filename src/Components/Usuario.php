...
{
    global $CAMPO_ID_USUARIO, $CAMPO_NOMBRE, $CAMPO_APELLIDOS;
    echo
        <<<HTML
        <div class='contenedor-datos'>
            <p><strong>Clave:</strong> {$usuario[$CAMPO_ID_USUARIO]}</p>
...
function componenteDatosUsuarioInicioJefeCarrera($usuario, $carrera, $correo)
{
    ...
    echo
        <<<HTML
        <div class='contenedor-datos'>
            <p><strong>Identificador:</strong> {$usuario[$CAMPO_ID_USUARIO]}</p>
            <p><strong>Nombre:</strong> {$usuario[$CAMPO_NOMBRE]}</p>
            <p><strong>Apellidos:</strong> {$usuario[$CAMPO_APELLIDOS]}</p>
...
function componenteDatosUsuarioInicioAlumno($usuario, $carrera, $correo, $grupo)
{
    global $CAMPO_ID_USUARIO, $CAMPO_NOMBRE, $CAMPO_APELLIDOS, $CAMPO_GRUPO;
    echo
        <<<HTML
        <div class='contenedor-datos'>
            <p><strong>Identificador:</strong>$usuario[$CAMPO_ID_USUARIO]</p>
